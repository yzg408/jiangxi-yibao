...
export const inpatientResident = {
  ...
  table: {
    ...
    '年度最高支付限额：基本医保10万元 + 大病保险40万元（连续参保满4年可提高封顶线）。',
  ...
  seriousIllness: {
    ...
    note: '要区分清楚：城乡居民大病 ≠ 职工大病。适用对象、起付线、报销比例、封顶线都不一样。职工的大病保险是自带的（10万触发、90%、50万封顶），居民的大病保险见下面。',
    deduct: '2025年约2.1万元（按上年度全省居民人均可支配收入的50%确定）',
    tiers: [
      { range: '2.1万 ~ 6.7万', ratio: '60%' },
      { range: '6.7万以上', ratio: '90%' }
    ],
    cap: '40万元/年',
    ...
    items: [
      '起付线：按上年度全省居民人均可支配收入的50%确定，2025年约2.1万元',
      '2.1万~6.7万：报销60%',
      '6.7万以上：报销90%',
      '年度封顶线：40万元',
